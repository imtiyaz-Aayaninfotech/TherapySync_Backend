...
exports.categoryValidation = Joi.object({
  category: Joi.string().valid('Individual Therapy', 'Couples Counseling', 'Family Therapy', 'Group Therapy', 'Other').required(),
  type: Joi.string().valid('1-on-1', 'Group', 'Online', 'Hybrid', 'Other').required(),
